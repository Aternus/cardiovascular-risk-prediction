...
📝 I've applied to their research program to gain access to the algorithm
...
4. ASCVD (atherosclerotic cardiovascular disease): risk of myocardial infarction
   ...
   hemorrhagic).
   1. ⚠️ `ASCVD` is a composite umbrella for `CHD + Stroke`
5. Total CVD (cardiovascular disease): any ASCVD event (CHD or stroke) and HF
   event.
   1. ⚠️ `Total CVD` is a composite umbrella for `ASCVD + HF`
...
⚠️ ASCVD is a composite and not a distinct event.
